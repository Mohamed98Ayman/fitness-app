...
import 'package:fitness_app/search/presentation/view/widgets/filters/modals/body_part_filter_modal.widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class BodyPartFilterButton extends ConsumerWidget {
  const BodyPartFilterButton({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isBodyPartSelected =
        ref.watch(appliedFiltersController).hasBodyPartFilter;
